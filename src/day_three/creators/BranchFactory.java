...
public class BranchFactory {
    ...
    public BranchFactory() {
        branchesFile = new File("C:\\Users\\playh\\IdeaProjects\\unit_one\\src\\day_three\\models\\firm\\brances");
        ...
        if (files != null && files.length > 0) {
            ...
            for (File file : files) {
                ...
                if (className.contains(".java")) {
                    ...
                    try {
                        c = Class.forName("day_three.models.firm.brances." + name).asSubclass(Branch.class);
